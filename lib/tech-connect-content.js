export const TECH_CONNECT_DEFAULT = {
  ...
  joeSupport: {
    ...
    secondaryLinks: [
      { label: "Get Help", href: "#help-paths" },
...
export function getTechConnectContent(content = {}) {
  ...
  return {
    ...
    joeSupport: {
      ...
      secondaryLinks: Array.isArray(techConnect.joeSupport?.secondaryLinks)
        ? techConnect.joeSupport.secondaryLinks
        : TECH_CONNECT_DEFAULT.joeSupport.secondaryLinks
    },
