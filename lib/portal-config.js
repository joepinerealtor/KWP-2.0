...
export const dailyAccessLinks = [
  ...
  { label: "KW Connect", href: "https://console.command.kw.com/connect/learning", external: true },
...
const brandQuickLinks = [
  ...
  { label: "KW Connect", href: "https://console.command.kw.com/connect/learning", button: "secondary", external: true }
];
...
export const portalPages = {
  home: {
    ...
    navLinks: [
      ...
      { label: "Tech Support", href: "#tech-help-joe" },
      { label: "Training Resources", href: "#training-resources" },
      { label: "Lone Wolf Transition", href: "lonewolf/", page: true },
    ...
    transitionNotice: {
      badge: "Transition Update",
      title: "DocuSign transition",
      summary: "DocuSign Rooms is scheduled to discontinue July 14, 2026. Begin getting familiar with Lone Wolf Transact.",
      href: "lonewolf/",
      cta: "View resources",
      ariaLabel: "Open Lone Wolf transition resources"
    },
    mobileQuickLinks: [
      ...
      { label: "Lone Wolf Transition", href: "lonewolf/", button: "secondary" },
      { label: "Suggest an Improvement", href: suggestionMailto, button: "secondary" }
    ],
    showJoeInQuickStrip: true,
    showHeaderJoeTracker: true,
    showDocuSignReminder: true,
  ...
  loneWolf: {
    lockLabel: "Lone Wolf Transition",
    brandHref: "../index.html#overview",
    brandLogo: "../brand/kw-leading-edge-logo.png",
    brandTitle: "Lone Wolf Transition",
    navLabel: "Lone Wolf transition sections",
    mobileMenusLabel: "Mobile portal menus",
    navLinks: [
      { label: "Home", href: "../index.html#overview", page: true },
      { label: "Overview", href: "#overview", active: true },
      { label: "Training", href: "#training" },
      { label: "KW Answers Articles", href: "#articles" },
    ...
    sidebarUtility: {
      ...
      title: "Quick Actions",
      links: [
        { label: "Watch May 4 Recording", href: "https://us02web.zoom.us/rec/share/yjD6DRnQhjQzp0C2WxapI19VuJX_Lq5zgIL0oq7Q2bLerUsqT4_i1pOn1DyEB44.opgy8pkcsT4Gv3Zf", button: "primary", external: true },
        { label: "Register for Classes", href: "https://us02web.zoom.us/meeting/register/I9f-0zJ6T8eLECtF70L_ew#/registration", button: "secondary", external: true },
        { label: "View KW Answers", href: "#articles", button: "secondary" },
        { label: "Back to Home", href: "../index.html#overview", button: "secondary" }
      ]
    },
    mobileQuickLinks: [
      { label: "Watch May 4 Recording", href: "https://us02web.zoom.us/rec/share/yjD6DRnQhjQzp0C2WxapI19VuJX_Lq5zgIL0oq7Q2bLerUsqT4_i1pOn1DyEB44.opgy8pkcsT4Gv3Zf", button: "primary", external: true },
